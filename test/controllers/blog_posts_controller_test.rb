...
class BlogPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blog_post" do
    assert_difference('BlogPost.count') do
      post blog_posts_url, params: { blog_post: { content: @blog_post.content, feature_image: @blog_post.feature_image, name: @blog_post.name, slug: @blog_post.slug } }
    end
  ...
  test "should update blog_post" do
    patch blog_post_url(@blog_post), params: { blog_post: { content: @blog_post.content, feature_image: @blog_post.feature_image, name: @blog_post.name, slug: @blog_post.slug } }
